...
import { blogpage5 } from '../../assets/img/contactimg'
                    ...
                    <Row className='text-white'>
                        <Col xs={12}>
                            <Card className='bg-transparent border-0'>
                                <Card.Img variant="top" src={blogpage5} className="img-thumbnail  rounded-4" />
                                <Card.Body>
                                    <Row >
                                        <Col><Card.Text><span>jun 5,2022</span> </Card.Text></Col>
