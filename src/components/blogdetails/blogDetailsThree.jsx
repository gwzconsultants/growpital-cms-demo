...
import { blogpage3, blogpage3_graph } from '../../assets/img/contactimg'
            ...
            <section>
                <Container  >
                    <Row className='text-white'>
                        <Col xs={12}>
                            <Card className='bg-transparent border-0 ' style={{ maxHeight: "25%" }} >
                                <Card.Img variant="top" src={blogpage3} className="img-thumbnail  rounded-4" />
                                <Card.Body>
                                    <Row >
                                        <Col><Card.Text><span>mar 25,2022</span> </Card.Text></Col>
